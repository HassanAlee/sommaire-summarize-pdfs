...
const steps: Step[] = [
  {
    ...
    label: "Upload PDF",
    descripton: "Simply drag and drop your PDF or click the upload",
  },
  {
  ...
  },
  {
    ...
    label: "Get Summary",
    descripton: "Receive a clear, concise summary of your document",
  },
];
  ...
  return (
    <section className="bg-gray-50 overflow-hidden relative">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%-3rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 bg-linear-to-br from-emerald-500 via-teal-500 to-cyan-500 opacity-20 sm:left-[calc(40%-30rem)] sm:w-[18.4075rem]"
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 27.2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
          ></div>
        </div>
...
function StepItem({ icon, label, descripton }: Step) {
  return (
    <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500/5 transition-colors group w-full">
      <div className="flex flex-col gap-4 h-full">
        ...
        <div className="flex flex-col flex-1 gap-1 justify-between">
          ...
          <p className="text-center text-gray-600 text-sm">{descripton}</p>
        </div>
      </div>
    </div>
  );
