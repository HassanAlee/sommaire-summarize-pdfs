  ...
  return (
    <section className="relative mx-auto flex  flex-col z-0 items-center justify-center py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
      <div className="text-center flex flex-col items-center">
        <div className="flex">
          <div className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-rose-200 via-rose-500 to-red-800 animate-gradient-x group mx-auto">
            <Badge
              variant={"secondary"}
              className="px-6 py-2 relative text-base font-medium bg-white rounded-full group-hover:bg-gray-200 transition-colors duration-200"
            >
